# https://github.com/flatterline/jekyll-plugins/blob/master/team.rb
...
module Jekyll
  class TeamIndex < Page
    def initialize(site, base, dir)
      ...
      # self.data['team'] seems to be accessible as page.team in the template
      # think this is done by Liquid when passed a Hash - the data is merged with certain
      # other attributes into a Hash, which is then passed to Liquid
      self.data['team'] = self.get_team(site)
      self.process(@name) # sets self.basename and self.ext
    end
